    ...
    public static List<TrainerDefinition> defaultDefinitions() {
        return List.of(
                ...
                fullCardDefinition("pyla", "Lady Pyla", Element.FIRE, Rarity.RARE, "SiegeKnight",
                        ...
                        new Ability("Kindlers Touch", "Heal A select row of Allies +1", TargetType.ROW_SELECT_ALLIES, null, 0, "heal", 1, false),
                        false,
                        "/img/knights/lady-pyla-full-card.png",
                        true),
                fullCardDefinition("ser-airek", "Ser Airek", Element.WIND, Rarity.RARE, "SiegeKnight",
                        Ability.passive("Wind Warden", "All Wind allies gain +2 max HP", "health_boost", 2),
                        new Ability("Aero Sphere", "Grant a select row of allies +2 Shield", TargetType.ROW_SELECT_ALLIES, null, 0, "shield", 2, false),
                        false,
                        "/img/knights/ser-airek-full-card.png",
                        true),
